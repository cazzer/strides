...
/**
 * A hand-built subset of BlazePose's 33-point output: the 12 COMMON_KEYPOINT_NAMES plus a
 * handful of BlazePose-only points (face refinements, fingers, heel/foot-index) that fall
 * outside that subset and must be dropped by toPoseFrame, same as MoveNet's face points are.
 */
